...
1. Response:
    ...
    | data.ct | int | 1579085877489 |  | 创建时间，毫秒级时间戳 |
    | data.fee | string | 0.0000 |  | 手续费 |
    | data.id | string | 1579085877489929001 |  |  |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"amount":"0.0000","ct":1579085877489,"fee":"0.0000","id":"1579085877489929001","mt":0,"price":"5030.060041","status":"Waiting","trade_volume":"0.0000","volume":"0.0100"}}
    ```
...
1. Response:
    ...
    | data | {} |  |  |  |
    | data.amount | string | 0.0000 |  | 成交额 |
    | data.ct | int | 1579085918946 |  | 创建时间，毫秒级时间戳 |
    | data.fee | string | 0.0000 |  | 手续费 |
    | data.id | string | 1579085918946354001 |  |  |
    | data.mt | int | 0 |  | 最后更新时间，毫秒级时间戳 |
    | data.price | string | 5030.060041 |  | 下单价格 |
    | data.status | string | Waiting |  | [订单状态](./枚举说明.md#现货订单状态) |
    | data.trade_volume | string | 0.0000 |  | 已成交数量 |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"amount":"0.0000","ct":1579085918946,"fee":"0.0000","id":"1579085918946354001","mt":0,"price":"5030.060041","status":"Waiting","trade_volume":"0.0000","volume":"0.0100"}}
    ```
...
1. Params:
    ...
    | Field | Type | Example | Necessary | Desc |
    | --- | --- | --- | --- | --- |
    | id | string | 1579085940973424001 |  | 订单ID，下单成功后会返回 |
    | symbol | string | btc_usdt |  | 交易对 |
...
1. Response:
    ...
    | data | {} |  |  |  |
    | data.amount | string | 0.0000 |  | 成交额 |
    | data.ct | int | 1579085940973 |  | 创建时间，毫秒级时间戳 |
    | data.fee | string | 0.0000 |  | 手续费 |
    | data.id | string | 1579085940973424001 |  |  |
    | data.mt | int | 0 |  | 最后更新时间，毫秒级时间戳 |
    | data.price | string | 5030.060041 |  | 下单价格 |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"amount":"0.0000","ct":1579085940973,"fee":"0.0000","id":"1579085940973424001","mt":0,"price":"5030.060041","status":"Canceled","trade_volume":"0.0000","volume":"0.0100"}}
    ```
...
1. Params:
    ...
    | Field | Type | Example | Necessary | Desc |
    | --- | --- | --- | --- | --- |
    | id | string | 1579085989831841001 |  | 订单ID，下单成功后会返回 |
    | symbol | string | btc_usdt |  | 交易对 |
...
1. Response:
    ...
    | data.ct | int | 1579085989831 |  | 创建时间，毫秒级时间戳 |
    | data.fee | string | 0 |  | 手续费 |
    | data.id | string | 1579085989831841001 |  |  |
    | data.mt | int | 0 |  | 最后更新时间，毫秒级时间戳 |
    | data.price | string | 5030.060041 |  | 下单价格 |
    | data.status | string | Waiting |  | [订单状态](./枚举说明.md#现货订单状态) |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"amount":"0","ct":1579085989831,"fee":"0","id":"1579085989831841001","mt":0,"price":"5030.060041","status":"Waiting","trade_volume":"0","volume":"0.01"}}
    ```
...
1. Params:
    ...
    | begin_time | int | 0 | N | 要查询的Kline开始时间（包含），传0则不筛选 |
    | direction | string | Desc | N | [排序方向](./枚举说明.md#排序方向) |
    | end_time | int | 1579155733 | N | 要查询的Kline结束时间（包含），传0则不筛选 |
    | limit | int | 3 | N | 条数，最大500 |
    | offset | int | 2 | N | 偏移量，注意是在[begin_time, end_time]条件下的偏移量 |
    | statuses | string | Canceled,Waiting | N | 要获取的订单状态，多个用`,`分割 |
    | symbol | string | BTC-USDT |  | 交易对 |
...
1. Response:
    ...
    | code | int | 1 |  |  |
    | data[i] | [] |  |  |  |
    | data[i].amount | string | 0.0000 |  | 成交额 |
    | data[i].ct | int | 1579085277505 |  | 创建时间，毫秒级时间戳 |
    | data[i].fee | string | 0.0000 |  | 手续费 |
    | data[i].id | string | 1579085277505967001 |  | 订单ID |
    | data[i].mt | int | 1579085287763 |  | 最后更新时间，毫秒级时间戳 |
    | data[i].price | string | 5030.060041 |  | 下单价格 |
    | data[i].status | string | Canceled |  | [订单状态](./枚举说明.md#现货订单状态) |
    | data[i].trade_volume | string | 0.0000 |  | 已成交数量 |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":[{"amount":"0.0000","ct":1579085483267,"fee":"0.0000","id":"1579085483267361001","mt":1579085495967,"price":"5030.060041","status":"Canceled","trade_volume":"0.0000","volume":"0.0100"},{"amount":"0.0000","ct":1579085453625,"fee":"0.0000","id":"1579085453625995001","mt":1579085466066,"price":"5030.060041","status":"Canceled","trade_volume":"0.0000","volume":"0.0100"},{"amount":"0.0000","ct":1579085277505,"fee":"0.0000","id":"1579085277505967001","mt":1579085287763,"price":"5030.060041","status":"Canceled","trade_volume":"0.0000","volume":"0.0100"}]}
    ```