...
1. Response:
    ...
    | data.coin_code | string | dk |  | 币种Code |
    | data.create_time | int | 1579170532 |  | 创建时间 |
    | data.status | string | Waiting |  | [提币地址状态](./枚举说明.md#提币地址状态) |
    | data.tag | string | testtag |  | 备注 |
    | data.uid | int | 1000001 |  | 用户ID |
    | data.update_time | int | 1579170532 |  | 更新时间 |
    | data.volume | string | 0.1 |  | 数量 |
    | data.withdraw_id | int | 1000103 |  | 提币记录ID |
    | msg | string |  |  |  |
    | ok | bool | true |  |  |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"addr":"dragonexmain","addr_id":1000004,"addr_name":"test","arrive_time":0,"coin_code":"dk","create_time":1579170532,"status":"Waiting","tag":"testtag","uid":1000001,"update_time":1579170532,"volume":"0.1","withdraw_id":1000103}}
    ```