...
1. Response:
    ...
    | data.list[i].status | string | Success |  | [提币状态](./枚举说明.md#提币状态) |
    ...
    | data.list[i].uid | int | 1000066 |  | 用户ID |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"count":1,"list":[{"addr":"dragonexmain","arrive_time":1575730454,"coin_code":"eth","prepay_id":1000001,"status":"Success","tag":"","tag_name":"","tx_id":"b12b6d30d79ae8b57c2cd3663153bc68ba0d6e25b3b216039bf419c99ec42c2a","uid":1000066,"volume":"15.4585"}]}}
    ```