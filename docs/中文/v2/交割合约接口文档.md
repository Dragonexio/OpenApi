...
1. Response:
    ...
    | data | {} |  |  |  |
    | data.list[i] | [] |  |  |  |
    | data.list[i].first_highest_volume | string | 50000 |  | 第一档最高可开张数 |
    ...
    | data.list[i].incr_volume | string | 50000 |  | 下单张数增量 |
...
1. Response:
    ...
    | data | {} |  |  |  |
    | data.list[i] | [] |  |  |  |
    | data.list[i].contract_value | string | 0.0001 |  | 合约面值 |
    | data.list[i].contract_value_coin_code | string | btc |  | 合约面值计价币种 |
    | data.list[i].lowest_volume | string | 100 |  | 最低下单张数 |
    ...
    | data.list[i].symbol | string | BTC_USDT |  | 交易对 |
    | data.list[i].trade_coin_code | string | btc |  | 交易币种Code |
...
1. Method: GET
1. URL: [/api/v2/delivery/contract/list/](https://openapi.dragonex.co/api/v2/delivery/contract/list/?margin_coin_code=USDT&symbol=btc-usdt&contract_type=ThisWeek&statuses=SettlementComplete,Listing&offset=0&limit=2)
1. Params:
...
1. Response:
    ...
    | data | {} |  |  |  |
    | data.contracts[i] | [] |  |  |  |
    | data.contracts[i].contract_code | string | BTC-USDT-20200814 |  | 合约Code |
    | data.contracts[i].contract_type | string | ThisWeek |  | [合约类型](#合约类型) |
    | data.contracts[i].delivery_date | int | 1597392000 |  | 交割日期, 秒级时间戳 |
    | data.contracts[i].listing_date | int | 1596182400 |  | 上市日期, 秒级时间戳 |
    | data.contracts[i].status | string | Listing |  | [合约状态](#合约状态) |
    | data.contracts[i].symbol | string | BTC-USDT |  | 交易对 |
    | data.symbols[i] | [] |  |  |  |
    | data.symbols[i].contract_value | string | 0.0001 |  | 合约面值 |
    | data.symbols[i].contract_value_coin_code | string | btc |  | 合约面值计价币种 |
    | data.symbols[i].lowest_volume | string | 100 |  | 最低下单张数 |
    ...
    | data.symbols[i].symbol | string | BTC_USDT |  | 交易对 |
