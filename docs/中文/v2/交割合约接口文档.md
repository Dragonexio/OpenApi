...
1. Method: GET
1. URL: [/api/v2/delivery/gradient/detail/](https://openapi.dragonex.co/api/v2/delivery/gradient/detail/?symbol=btc-usdt&margin_coin_code=USDT)
1. Params:
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"first_highest_volume":"50000","first_lowest_init_ratio":"0.01","first_maintain_ratio":"0.005","highest_count":50,"incr_lowest_init_ratio":"0.005","incr_maintain_ratio":"0.005","incr_volume":"50000","symbol":"BTC-USDT"}}
    ```

## 查询梯度维持保证金列表

1. Method: GET
1. URL: [/api/v2/delivery/gradient/list/](https://openapi.dragonex.co/api/v2/delivery/gradient/list/?margin_coin_code=USDT&offset=0&limit=10)
1. Params:
...
1. Response:
    ...
    | data | string |  |  |  |
    | data.list | string |  |  |  |
    | data.list.first_highest_volume | string | 50000 |  | 第一档最高可开张数 |
    | data.list.first_lowest_init_ratio | string | 0.01 |  | 第一档最低初始保证金率 |
    | data.list.first_maintain_ratio | string | 0.005 |  | 第一档维持保证金率 |
    | data.list.highest_count | string | 50 |  | 最大档位 |
    | data.list.incr_lowest_init_ratio | string | 0.005 |  | 最低初始保证金率增量 |
    | data.list.incr_maintain_ratio | string | 0.005 |  | 维持保证金率增量 |
    | data.list.incr_volume | string | 50000 |  | 下单张数增量 |
    | data.list.symbol | string | BTC-USDT |  | 交易对 |
    | data.total | string | 1 |  | 总条数 |
    | msg | string |  |  |  |
    | ok | string | true |  |  |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"list":[{"first_highest_volume":"50000","first_lowest_init_ratio":"0.01","first_maintain_ratio":"0.005","highest_count":50,"incr_lowest_init_ratio":"0.005","incr_maintain_ratio":"0.005","incr_volume":"50000","symbol":"BTC-USDT"}],"total":1}}
    ```

## 查询交易对详情

1. Method: GET
1. URL: [/api/v2/delivery/symbol/detail/](https://openapi.dragonex.co/api/v2/delivery/symbol/detail/?symbol=BTC-USDT&margin_coin_code=USDT)
1. Params:
...
1. Response:
    ...
    | code | string | 1 |  |  |
    | data | string |  |  |  |
    | data.contract_value | string | 0.0001 |  | 合约面值 |
    | data.contract_value_coin_code | string | btc |  | 合约面值计价币种 |
    | data.lowest_volume | string | 100 |  | 最低下单张数 |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"contract_value":"0.0001","contract_value_coin_code":"btc","lowest_volume":"100","order_toggle":"On","price_precision":"0","quote_coin_code":"usdt","symbol":"BTC_USDT","trade_coin_code":"btc","volume_precision":"0"}}
    ```

## 查询交易对列表

1. Method: GET
1. URL: [/api/v2/delivery/symbol/list/](https://openapi.dragonex.co/api/v2/delivery/symbol/list/?margin_coin_code=USDT&offset=0&limit=10)
1. Params:
...
1. Response:
    ...
    | data | string |  |  |  |
    | data.list | string |  |  |  |
    | data.list.contract_value | string | 0.0001 |  | 合约面值 |
    | data.list.contract_value_coin_code | string | btc |  | 合约面值计价币种 |
    | data.list.lowest_volume | string | 100 |  | 最低下单张数 |
    | data.list.order_toggle | string | On |  | [开关](#开关) |
    | data.list.price_precision | string | 0 |  | 下单价格精度，如：0.01-允许有2位小数，0-只允许整数 |
    | data.list.quote_coin_code | string | usdt |  | 计价币种Code |
    | data.list.symbol | string | BTC_USDT |  | 交易对 |
    | data.list.trade_coin_code | string | btc |  | 交易币种Code |
    | data.list.volume_precision | string | 0 |  | 下单数量精度，如：0.01-允许有2位小数，0-只允许整数 |
    | data.total | string | 1 |  | 总条数 |
    | msg | string |  |  |  |
    | ok | string | true |  |  |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"list":[{"contract_value":"0.0001","contract_value_coin_code":"btc","lowest_volume":"100","order_toggle":"On","price_precision":"0","quote_coin_code":"usdt","symbol":"BTC_USDT","trade_coin_code":"btc","volume_precision":"0"}],"total":1}}
    ```
...
1. Params:
    ...
    | contract_type | string | ThisWeek | N | [合约类型](./枚举说明.md#交割合约合约类型) |
...
1. Response:
    ...
    | data.contract.contract_type | string | ThisWeek |  | [合约类型](./枚举说明.md#交割合约合约类型) |
    | data.contract.delivery_date | int | 1578038400 |  | 交割日期, 秒级时间戳 |
    | data.contract.listing_date | int | 1576828800 |  | 上市日期, 秒级时间戳 |
    | data.contract.status | string | SettlementComplete |  | [合约状态](./枚举说明.md#交割合约合约状态) |
    ...
    | data.symbol.order_toggle | string | On |  | [下单开关](./枚举说明.md#开关) |
...
1. Method: GET
1. URL: [/api/v2/delivery/contract/list/](https://openapi.dragonex.co/api/v2/delivery/contract/list/?margin_coin_code=USDT&symbol=btc-usdt&contract_type=ThisWeek&statuses=略&offset=0&limit=2)
1. Params:
...
1. Response:
    ...
    | code | string | 1 |  |  |
    | data | string |  |  |  |
    | data.contracts | string |  |  |  |
    | data.contracts.contract_code | string | 略 |  | 合约Code |
    | data.contracts.contract_type | string | ThisWeek |  | [合约类型](#合约类型) |
    | data.contracts.delivery_date | string | 略 |  | 交割日期, 秒级时间戳 |
    | data.contracts.listing_date | string | 略 |  | 上市日期, 秒级时间戳 |
    | data.contracts.status | string | Listing |  | [合约状态](#合约状态) |
    | data.contracts.symbol | string | BTC-USDT |  | 交易对 |
    | data.symbols | string |  |  |  |
    | data.symbols.contract_value | string | 0.0001 |  | 合约面值 |
    | data.symbols.contract_value_coin_code | string | btc |  | 合约面值计价币种 |
    | data.symbols.lowest_volume | string | 100 |  | 最低下单张数 |
    | data.symbols.order_toggle | string | On |  | [下单开关](#开关) |
    | data.symbols.price_precision | string | 0 |  | 下单价格精度，如：0.01-允许有2位小数，0-只允许整数 |
    | data.symbols.quote_coin_code | string | usdt |  | 计价币种Code |
    | data.symbols.symbol | string | BTC_USDT |  | 交易对 |
    | data.symbols.trade_coin_code | string | btc |  | 交易币种Code |
    | data.symbols.volume_precision | string | 0 |  | 下单数量精度，如：0.01-允许有2位小数，0-只允许整数 |
    | msg | string |  |  |  |
    | ok | string | true |  |  |
...
1. Example:
    ...
    ```json
    {"ok":true,"code":1,"msg":"","data":{"contracts":[{"contract_code":"BTC-USDT-20200814","contract_type":"ThisWeek","delivery_date":1597392000,"listing_date":1596182400,"status":"Listing","symbol":"BTC-USDT"}],"symbols":[{"contract_value":"0.0001","contract_value_coin_code":"btc","lowest_volume":"100","order_toggle":"On","price_precision":"0","quote_coin_code":"usdt","symbol":"BTC_USDT","trade_coin_code":"btc","volume_precision":"0"}]}}
    ```
...
1. Params:
    ...
    | contract_code | string | BTC-USDT-20200103 |  | 合约Code |
    | cycle | string | 1min |  | [K线类型](./枚举说明.md#K线类型) |
...
1. Response:
    ...
    | data.margin_mode | string | Crossed |  | [账户类型](./枚举说明.md#交割合约账户类型) |
    | data.symbol | string | BTC-USDT |  | 交易对 |
    | msg | string |  |  |  |
    | ok | bool | true |  |  |
...
1. Response:
    ...
    | data.list[i].contract_type | string | ThisWeek |  | [合约类型](./枚举说明.md#交割合约合约类型) |
    ...
    | data.list[i].side | string | Long |  | [成交方向](./枚举说明.md#成交方向) |
...
1. Params:
    ...
    | Field | Type | Example | Necessary | Desc |
    | --- | --- | --- | --- | --- |
    | contract_type | string | ThisWeek |  | [合约类型](./枚举说明.md#交割合约合约类型) |
    | margin_coin_code | string | usdt |  | 保证金币种Code |
...
1. Response:
    ...
    | data.positions[i].contract_type | string | ThisWeek |  | [合约类型](./枚举说明.md#交割合约合约类型) |
    ...
    | data.positions[i].side | string | Long |  | [成交方向](./枚举说明.md#成交方向) |
...
1. Response:
    ...
    | data[i].positions[i].contract_type | string | ThisWeek |  | [合约类型](./枚举说明.md#交割合约合约类型) |
    ...
    | data[i].positions[i].side | string | Long |  | [成交方向](./枚举说明.md#成交方向) |
...
1. Params:
    ...
    | margin_coin_code | string | usdt |  | 保证金币种Code |
    | order_side | string | OpenLong |  | [下单方向](./枚举说明.md#交割合约下单方向) |
    | order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | price | string | 1 |  | 委托价格 |
...
1. Response:
    ...
    | data.order_side | string | OpenLong |  | [下单方向](./枚举说明.md#交割合约下单方向) |
    | data.order_side_desc | string | 买入开多 |  |  |
    | data.order_status | string | Creating |  | [订单状态](./枚举说明.md#交割合约订单状态) |
    | data.order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | data.price | string | 1 |  | 价格 |
    | data.profit | string | 0 |  | 收益 |
    | data.system_type | string | Normal |  | [订单类型补充说明](./枚举说明.md#交割合约订单类型补充说明) |
...
1. Response:
    ...
    | data.order_side | string | OpenLong |  | [下单方向](./枚举说明.md#交割合约下单方向) |
    | data.order_side_desc | string | 买入开多 |  |  |
    | data.order_status | string | Pending |  | [订单状态](./枚举说明.md#交割合约订单状态) |
    | data.order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | data.price | string | 1 |  | 价格 |
    | data.profit | string | 0 |  | 收益 |
    | data.system_type | string | Normal |  | [订单类型补充说明](./枚举说明.md#交割合约订单类型补充说明) |
...
1. Response:
    ...
    | data.order_side | string | OpenLong |  | [下单方向](./枚举说明.md#交割合约下单方向) |
    | data.order_side_desc | string | 买入开多 |  |  |
    | data.order_status | string | Cancelled |  | [订单状态](./枚举说明.md#交割合约订单状态) |
    | data.order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | data.price | string | 1 |  | 价格 |
    | data.profit | string | 0 |  | 收益 |
    | data.system_type | string | Normal |  | [订单类型补充说明](./枚举说明.md#交割合约订单类型补充说明) |
...
1. Method: POST
1. URL: [/api/v2/delivery/user/order/list/unfinished/](https://openapi.dragonex.co/api/v2/delivery/user/order/list/unfinished/)
1. Params:
...
1. Response:
    ...
    | data.list[i].order_side | string | OpenLong |  | [下单方向](./枚举说明.md/#交割合约下单方向) |
    | data.list[i].order_side_desc | string | 买入开多 |  | 订单方向说明 |
    | data.list[i].order_status | string | Pending |  | [订单状态](./枚举说明.md#交割合约订单状态) |
    | data.list[i].order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | data.list[i].price | string | 1 |  | 价格 |
    | data.list[i].profit | string | 0 |  | 收益 |
    | data.list[i].system_type | string | Normal |  | [订单类型补充说明](./枚举说明.md#交割合约订单类型补充说明) |
...
1. Method: POST
1. URL: [/api/v2/delivery/user/order/list/finished/](https://openapi.dragonex.co/api/v2/delivery/user/order/list/finished/)
1. Params:
...
1. Response:
    ...
    | data.list[i].order_side | string | OpenLong |  | [下单方向](./枚举说明.md#交割合约下单方向) |
    | data.list[i].order_side_desc | string | 买入开多 |  | 订单方向说明 |
    | data.list[i].order_status | string | Cancelled |  | [订单状态](./枚举说明.md#交割合约订单状态) |
    | data.list[i].order_type | string | Limit |  | [下单类型](./枚举说明.md#交割合约下单类型) |
    | data.list[i].price | string | 1 |  | 价格 |
    | data.list[i].profit | string | 0 |  | 收益 |
    | data.list[i].system_type | string | Normal |  | [订单类型补充说明](./枚举说明.md#订单类型补充说明) |
    | data.list[i].uid | int | 1000001 |  | 用户ID |
...
1. Method: POST
1. URL: [/api/v2/delivery/user/bill/list/](https://openapi.dragonex.co/api/v2/delivery/user/bill/list/)
1. Params:
...
1. Response:
    ...
    | data[i].symbol | string | BTC-USDT |  | 交易对 |
    | data[i].type | string | Delivery2Coin |  | [账单类型](./枚举说明.md#账单类型) |
